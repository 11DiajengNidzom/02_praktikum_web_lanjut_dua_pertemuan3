...
<head>
    ...
    <script src="{{ assets('assetjs/custom.js') }}"></script>
    <script src="{{ assets('assetjs/slides/slides.min.jquery.js') }}"></script>
    <script src="{{ assets('assetjs/cycle-slider/cycle.js') }}"></script>
    <script src="{{ assets('assetjs/nivo-slider/jquery.nivo.slider.js') }}"></script>
    <script src="{{ assets('assetjs/tabify/jquery.tabify.js') }}"></script>
    <script src="{{ assets('assetjs/prettyPhoto/jquery.prettyPhoto.js') }}"></script>
    <script src="{{ assets('assetjs/twitter/jquery.tweet.js') }}"></script>
    <script src="{{ assets('assetjs/scrolltop/scrolltopcontrol.js') }}"></script>
    <script src="{{ assets('assetjs/portfolio/filterable.js') }}"></script>
    <script src="{{ assets('assetjs/modernizr/modernizr-2.0.3.js') }}"></script>
    <script src="{{ assets('assetjs/easing/jquery.easing.1.3.js') }}"></script>
    <script src="{{ assets('assetjs/kwicks/jquery.kwicks-1.5.1.pack.js') }}"></script>
    <script src="{{ assets('assetjs/swfobject/swfobject.js') }}"></script>
    <!-- FancyBox -->
    <link rel="stylesheet" type="text/css" href="{{ assets('assets/js/fancybox/jquery.fancybox.css') }}" media="all">
...
<body>
    <div class="header">
        <!-- Logo/Title -->
        <div id="site_title"><a href="index.html"> <img src="{{ assets('asset/img/logo.png') }}" alt=""></a> </div>
        <!-- Main Menu -->
        <ol id="menu">
    ...
    <div id="container">
        <div class="two-third">
            <div id="slider3" class="nivoSlider" style="width: 630px; height: 280px"> <a href="#"><img
                        title="Heading Here" src="img/demo/slide_11.jpg" alt="" width="630" height="280"></a> <img
                    src="img/demo/slide_21.jpg" alt="" width="630" height="280"> <img src="img/demo/slide_31.jpg" alt=""
                    width="630" height="280"> </div>
            <div style="clear:both"></div>
            <div class="one-third">
                <h2>Photoshoot in Paris</h2>
                <img src="img/frontpage_thumb2.jpg" alt="">
                <p>Perquiramus atque ut casus tui ex quae ad te ad suis caelo dicit hoc. Tempore percussus ait est amet
                    consensit cellula rei civibus in modo ad nomine.</p>
                <p style="text-align:right"><a href="#" class="button_small white">Continue Reading &raquo;</a></p>
            </div>
            <div class="one-third last">
                <h2>Studio Photography</h2>
                <img src="img/frontpage_thumb3.jpg" alt="">
                <p>Perquiramus atque ut casus tui ex quae ad te ad suis caelo dicit hoc. Tempore percussus ait est amet
                    consensit cellula rei civibus in modo ad nomine.</p>
                <p style="text-align:right"><a href="#" class="button_small white">Continue Reading &raquo;</a></p>
            </div>
            <div class="one-third">
                <h2>Lorem Ipsum</h2>
                <img src="img/frontpage_thumb4.jpg" alt="">
                <p>Perquiramus atque ut casus tui ex quae ad te ad suis caelo dicit hoc. Tempore percussus ait est amet
                    consensit cellula rei civibus in modo ad nomine.</p>
                <p style="text-align:right"><a href="#" class="button_small white">Continue Reading &raquo;</a></p>
            </div>
            <div class="one-third last">
                <h2>Tempore Amet</h2>
                <img src="img/frontpage_thumb1.jpg" alt="">
                <p>Perquiramus atque ut casus tui ex quae ad te ad suis caelo dicit hoc. Tempore percussus ait est amet
                    consensit cellula rei civibus in modo ad nomine.</p>
                <p style="text-align:right"><a href="#" class="button_small white">Continue Reading &raquo;</a></p>
            </div>
        ...
        <div class="sidebar_right">
            ...
            <div id="fane1" class="tab_content">
                <div class="tab_article"> <img src="img/thumb1.jpg" alt="">
                    <p>Perquiramus atque ut casus tui ex quae ad te ad suis caelo dicit hoc. Perquiramus atque ut casus
                        tui.</p>
                </div>
    ...
    <div id="footer">
        ...
        <div class="one-fourth last">
            <h3>Socialize</h3>
            <img src="img/icon_fb.png" alt=""> <img src="img/icon_twitter.png" alt=""> <img src="img/icon_in.png"
                alt="">
        </div>
        <div style="clear:both"></div>
    </div>
